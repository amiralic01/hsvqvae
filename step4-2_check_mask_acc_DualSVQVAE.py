...
if __name__ == '__main__':
    ...
    # model_checkpoint = 'checkpoints/train-dualsvqvae-withmask-wbc_1-1024_023602/checkpoints/dualsvqvae_best_95.pt'
    # model_checkpoint = 'checkpoints/train-dualsvqvae-withmask-wbc_10-1024_032703/checkpoints/dualsvqvae_best_61.pt'
    model_checkpoint = 'checkpoints/train-dualsvqvae-withmask-wbc_50-1024_033037/checkpoints/dualsvqvae_best_34.pt'
    # model_checkpoint = 'checkpoints/train-dualsvqvae-withmask-wbc_1-1024_012902/checkpoints/dualsvqvae_best_98.pt'
    ...
    for name in losses:
        ...
        if 'acc' in name:
            ...
            plt.ylabel('Loss')
        plt.title(f'Finetune DualSVQVAE {ds}: {name}')
        plt.xlabel('Epoch')
        
        plt.savefig(f"output/finetune-dual-mask-{ds.replace(' ','-')}-{name}.png") 
    ...
    # # Updated title to reflect DualSVQVAE
    # plt.title(f'DualSVQVAE Confusion Matrix for WBC Testing dataset (with mask), trained on {ds}')
    # plt.ylabel('Ground Truth Labels')
    # plt.xlabel('Predicted Labels')
    # plt.tight_layout()
    # plt.savefig(f"output/finetune-dual-mask-{ds.replace(' ', '-')}-confusion-matrix.png")