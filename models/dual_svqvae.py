...
class DualSVQVAE(nn.Module):
    def __init__(
        self,
        img_size,
        in_channel=3,
        num_classes=5,
        num_vaes=3,  # Total number of VAEs (SVQVAE1: 3, SVQVAE2: 2) more of a compatibility option for the SVQVAE interface
        ...
        assert num_vaes >= 3, "num_vaes must be at least 3 for DualSVQVAE (SVQVAE1: 3, SVQVAE2: 2)"
    ...
    def decode(self, joint_quant, from_level, to_level):
        ...
        # If decoding from SVQVAE2 to SVQVAE1 (complex case, reconstruction won't be perfect)
        else:
            ...
            # The result is now at SVQVAE2 level 0 output
            # We would need the original SVQVAE1 level 3 encoding to properly continue
            # This is an approximation as we don't have that information
            return joint_quant
