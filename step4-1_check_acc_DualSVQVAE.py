...
if __name__ == '__main__':
    ...
    model_checkpoint = 'checkpoints/train-dualsvqvae-wbc_100-1024_023002/checkpoints/dualsvqvae_best_95.pt'
    # model_checkpoint = 'checkpoints/train-dualsvqvae-wbc_50-1024_022839/checkpoints/dualsvqvae_best_92.pt'
    # model_checkpoint = 'checkpoints/train-dualsvqvae-wbc_10-1024_022301/checkpoints/dualsvqvae_best_95.pt'
    # model_checkpoint = 'checkpoints/train-dualsvqvae-wbc_1-1024_012902/checkpoints/dualsvqvae_best_98.pt'
    ...
    for name in losses:
        ...
        plt.savefig(f"output/finetune-dual-{ds.replace(' ','-')}-{name}.png") 
    ...
    plt.title(f'DualSVQVAE Confusion Matrix for WBC Testing dataset, trained on {ds}')
    plt.ylabel('Ground Truth Labels')
    plt.xlabel('Predicted Labels')
    plt.tight_layout()
    plt.savefig(f"output/finetune-dual-{ds.replace(' ', '-')}-confusion-matrix.png")